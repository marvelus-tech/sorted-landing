...
const AGENT_PROMPT = 'Visit https://marvelus-tech.github.io/sorted-landing/ and explore their agent tools. Join my household with my pet\'s info and check if we need to reorder food.'
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-ink-muted leading-relaxed mb-8 max-w-lg">
            ...
            finds the best price, and reports back — your AI agent handles it through WebMCP tools.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <button onClick={copyAgentPrompt} className="bg-ink text-cream px-8 py-4 rounded-full text-base font-medium hover:bg-ink-light transition-all hover:shadow-lg flex items-center justify-center gap-2">
        ...
        <motion.div
          ...
          className="relative"
        >
          {/* Agent chat demo - The Wow Moment */}
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-lg text-ink-muted leading-relaxed">
              SORTED removes the mental load entirely. Your AI agent joins via WebMCP, learns your pet's consumption, and makes sure the bowl is never empty — at the best possible price, without you lifting a finger.
            </p>
            <div className="space-y-4 pt-4">
              {[
  ...
  const steps = [
    {
      ...
      description: "Point your AI agent at SORTED. It joins with your pet info — breed, age, diet, favorite brands."
    },
    {
      icon: Brain,
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-ink-muted max-w-2xl mx-auto">
            No apps to download. No passwords to remember. Just your AI agent — and WebMCP tools on this page.
          </p>
        </motion.div>
...
function Testimonials() {
  const testimonials = [
    ...
    {
      stars: 5,
      text: "We have three cats with different diets. SORTED bundles their orders perfectly and always finds the cheapest vendor. The agent workflow is genius — I don't need another app.",
      name: "David K.",
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg text-cream/70 mb-10 max-w-2xl mx-auto">
            ...
            Copy the prompt for your agent — no credit card required.
          </p>
          
          <button onClick={copyAgentPrompt} className="bg-cream text-ink px-10 py-4 rounded-full text-base font-medium hover:bg-cream-dark transition-all hover:shadow-lg inline-flex items-center gap-2">
            Copy Prompt for My Agent
            <ArrowRight className="w-5 h-5" />
          </button>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/sorted-landing/llms.txt" className="text-sm text-ink-muted hover:text-ink transition-colors">llms.txt</a></li>
        ...
        <div className="border-t border-cream pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-ink-muted hover:text-ink transition-colors">
              <span className="sr-only">WebMCP</span>
